...
use crate::models::{Config, HeuristicStandard, get_units};
...
impl Engine {
    ...
    pub fn init(&mut self, config: &Config) {
        ...
        for unit in units.iter() {
            ...
            self.precedents.insert(unit.id.clone(), prime);
        }
        ...
        for unit in units.iter() {
            ...
            self.heuristic_standards.insert(unit.id.clone(), HeuristicStandard {
